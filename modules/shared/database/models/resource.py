...
class Resource(Base):
    ...
    # Basic info
    name = Column(String(500), nullable=False)
    type = Column(String(100), nullable=False)  # 'food'|'water'|'medicine'|'shelter'|'supplies'
    ...
    # Center relationship
    center_id = Column(UUID(as_uuid=True), ForeignKey("rescue_centers.id"), nullable=False)
    ...
    def __repr__(self):
        return f"<Resource(id={self.id}, name={self.name}, quantity={self.available_quantity}/{self.quantity})>"
