...
class School(Base):
    ...
    # School type
    type = Column(String(50), nullable=False)  # 'elementary'|'middle'|'high'|'university'
    ...
    def __repr__(self):
        return f"<School(id={self.id}, name={self.name}, green_score={self.green_score})>"
    ...
    def to_ngsi_ld(self):
        ...
        return {
            ...
            "greenScore": {
                "type": "Property",
                "value": float(self.green_score)
            } if self.green_score else None,
            "schoolType": {
                "type": "Property",
                "value": self.type
            }
