...
class AirQuality(Base):
    ...
    data_uri = Column(String(500), nullable=True)  # e.g., /api/open-data/air-quality/{id}
    ngsi_ld_uri = Column(String(500), nullable=True)  # e.g., urn:ngsi-ld:AirQuality:HN-001
    ...
    def to_ngsi_ld(self):
        ...
        return {
            ...
            } if self.aqi else None,
            "pm25": {
                "type": "Property",
                "value": float(self.pm25),
                "unitCode": "µg/m³"
            } if self.pm25 else None,
            "pm10": {
                "type": "Property",
                "value": float(self.pm10),
                "unitCode": "µg/m³"
            } if self.pm10 else None,
            "source": {
                "type": "Property",
                "value": self.source
            }
