...
const SecurityScreen = () => {
  ...
  const [verificationModalData, setVerificationModalData] = useState({ title: '', message: '' });
  ...
  const VERIFICATION_ITEMS = [
    {
      ...
      onPress: isEkycVerified ? () => {
        setVerificationModalData({
          title: t('security.identityVerifiedDesc'),
          message: ''
        });
        setVerificationModalVisible(true);
      } : () => handleStartEkyc(),
    ...
    },
    {
      ...
      onPress: isEmailVerified ? () => {
        setVerificationModalData({
          title: t('security.emailVerifiedDesc'),
          message: ''
        });
        setVerificationModalVisible(true);
    ...
    },
    {
      ...
      onPress: isPhoneVerified ? () => {
        setVerificationModalData({
          title: t('security.phoneVerifiedDesc'),
          message: ''
        });
        setVerificationModalVisible(true);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <VerificationModal
        ...
        title={verificationModalData.title}
        message={verificationModalData.message}
        buttonText="Đóng"
        animationSize={200}
      />
    </SafeAreaView>
