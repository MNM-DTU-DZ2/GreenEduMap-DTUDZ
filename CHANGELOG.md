...
### New Features
- Hoàn thiện thiết lập environment service và sửa các lỗi nghiêm trọng
- Tạo service auth và docker-compose
- Thiết lập ban đầu sau khi tái cấu trúc
- Thêm công cụ tự động hóa Git bằng PowerShell (git-push.ps1, create-release.ps1)

### Bug Fixes
- Sửa CODE_OF_CONDUCT và CONTRIBUTING
- Cập nhật README.md
- Sửa lỗi encoding font tiếng Việt trong scripts
- Sửa lỗi banner

### Documentation
- Cập nhật CHANGELOG.md
- Cập nhật cấu trúc tài liệu và README.md
- Thêm tài liệu hướng dẫn setup, đóng góp
- Thêm tài liệu API và kiến trúc hệ thống

### Refactor
- Tái cấu trúc dự án theo chuẩn CityResQ360
- Dọn dẹp thư mục gốc, chỉ giữ lại các file thiết yếu
- Tổ chức lại thư mục docs và scripts
